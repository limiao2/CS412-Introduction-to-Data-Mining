1. For step one, I implement the Apriori frequent pattern mining algorithm. In this python code, I implement 6 functions: readinfile, frequentitemset,join,apriori,readinvoc and writeout.
    ...
    The join function will join candidates who satisfy minimum support,user can define level k by them self
    The apriori function will return list L which includes from L1, L2... to Lk. And also related support data.
